...
<div class="header">
    ...
    <main >
    <h1 style="text-align: center;"><u><i>Cancellation Booking</i></u></h1>
            <?php 
        ...
        <div class="statusBooking">
          <table>
            ...
            <tr>
              ...
              <td><?php echo ($isActive ? "Active" : "Expired");?></td>
              <?php if($isActive){?>
              <td><a style="color: blue;" onclick="CancelComf()">Cancel the booking</a></td>
              <?php }else{?>
                <td>Expired</td>
                <?php }?>
    ...
    function CancelComf(){
        if(confirm("Are you sure you want to perform this action?")) {
            ...
            window.location.href = "./cancelBooking.php?bookingid=<?php echo $b_id;?>";
        }
    }
      </script>
</body>
